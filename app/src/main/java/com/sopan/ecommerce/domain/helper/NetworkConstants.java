package com.sopan.ecommerce.domain.helper;
...
public interface NetworkConstants {
     ...
     */
    public static final String URL_GET_ALL_CATEGORY = URL_BASE_URI + "categories";

    /**
     * The Constant URL_GET_PRODUCTS_BY_CATEGORY.
     */
    public static final String URL_GET_PRODUCTS_MAP = URL_BASE_URI + "productMap";
